...
FunctionsToExport = 'Get-AzVMwareAddon', 'Get-AzVMwareAuthorization', 
               ...
               'Get-AzVMwareGlobalReachConnection', 'Get-AzVMwareHost', 
               'Get-AzVMwareIscsiPath', 'Get-AzVMwarePlacementPolicy', 
               'Get-AzVMwarePrivateCloud', 
               'Get-AzVMwarePrivateCloudAdminCredential', 
               'Get-AzVMwareProvisionedNetwork', 'Get-AzVMwarePureStoragePolicy', 
               'Get-AzVMwareSku', 'Get-AzVMwareVirtualMachine', 'New-AzVMwareAddon', 
               ...
               'Remove-AzVMwarePrivateCloud', 'Remove-AzVMwarePureStoragePolicy', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated the AVS VMware cmdlets api version to ''2024-09-01''. 
* Added cmdlet:
    - ''Get-AzVMwareHost''
    - ''Get-AzVMwareSku''
